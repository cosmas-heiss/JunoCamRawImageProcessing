...
pos = np.array([0.41,-0.7,-0.31])
pos *= JUPITER_EQUATORIAL_RADIUS / np.linalg.norm(pos)
pos[2] *= JUPITER_POLAR_RADIUS / JUPITER_EQUATORIAL_RADIUS
FRAMELET_RES = 1328

image1 = dir_path + '/../RawImageData/PJ07/RawImages/JNCE_2017192_07C00061_V01-raw.png'
im_info1 = dir_path + '/../RawImageData/PJ07/RawImageData/JNCE_2017192_07C00061_V01.json'
image2 = dir_path + '/../RawImageData/PJ07/RawImages/JNCE_2017192_07C00062_V01-raw.png'
im_info2 = dir_path + '/../RawImageData/PJ07/RawImageData/JNCE_2017192_07C00062_V01.json'
raster = project_tangential_plane(pos, 18000, 18000, FRAMELET_RES, FRAMELET_RES, 0)
...
pixel_in_meter = 17500 * 1000 / FRAMELET_RES


vel = compute_optical_flow(img1, img2, mask=mask, error_fields=all_gradient_fields) * pixel_in_meter / time_delay
...
plt.savefig('Optical_flow_pj7_red_spot.png')


factor = 1.3 * time_delay / pixel_in_meter
...
with imageio.get_writer('pj7_red_dot_movie.gif', mode='I') as writer:
    for image in images:
